			...
			sidebar: [
				{
					...
					items: [
						...
						{ label: '4. Как устроена оперативная память', slug: 'virtualization/memory-basics' },
						{ label: '5. Виртуализация памяти', slug: 'virtualization/memory' },
						{ label: '6. Виртуализация ввода-вывода', slug: 'virtualization/io' },
						{ label: '7. Паравиртуализация', slug: 'virtualization/paravirtualization' },
						{ label: '8. Контейнеры vs виртуальные машины', slug: 'virtualization/containers-vs-vm' },
						{ label: '9. KVM/QEMU на практике', slug: 'virtualization/kvm-qemu' },
						{ label: '10. Обзор платформ', slug: 'virtualization/platforms' },
						{ label: '★ Задания', slug: 'virtualization/exercises' },
						{ label: '11. Глоссарий и ссылки', slug: 'virtualization/glossary' },
					],
				},
				{
